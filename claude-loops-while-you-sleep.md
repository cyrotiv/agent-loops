...
**Author:** Hanako ([@hanakoxbt](https://x.com/hanakoxbt))
...
*Transcribed from the X article for offline reference. Embedded images from the original are omitted; see the source link above.*
